...
describe("repository hygiene", () => {
  ...
  it("記事運用と移行手順のドキュメントが揃っている", async () => {
    ...
    expect(writingGuide).toContain("4〜8 往復")
    ...
    expect(writingGuide).toContain("検索者が実際に打つ語")
    expect(writingGuide).toContain("前半")
    expect(writingGuide).toContain("実装記録")
    expect(writingGuide).toContain("120〜140字")
    expect(writingGuide).toContain("読者が何を得るか")
    expect(writingGuide).toContain("記事に無い約束")
