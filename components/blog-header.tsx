    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 pointer-events-none">
        <div className="flex items-center justify-between px-4 py-3 md:px-8 md:py-6">
          ...
          <div className="pointer-events-auto">
            {loading ? (
              <div className="w-8 h-8 rounded-full bg-slate-200 dark:bg-gray-700 animate-pulse" />
            ) : user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-52 bg-white dark:bg-popover text-slate-900 dark:text-popover-foreground border-slate-200 dark:border-border">
                  ...
                  <DropdownMenuSeparator className="bg-slate-200 dark:bg-border" />
                  <DropdownMenuItem asChild>
                    <Link href="/profile" className="cursor-pointer text-slate-600 dark:text-muted-foreground hover:bg-slate-50 dark:hover:bg-accent hover:text-slate-900 dark:hover:text-accent-foreground">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/settings" className="cursor-pointer text-slate-600 dark:text-muted-foreground hover:bg-slate-50 dark:hover:bg-accent hover:text-slate-900 dark:hover:text-accent-foreground">
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <DropdownMenuItem
                    ...
                    disabled={signingOut}
                    className="text-red-600 cursor-pointer focus:text-red-600 focus:bg-red-50 hover:bg-red-50 dark:hover:bg-destructive/10"
                  >
                    {signingOut ? (
                      <>
