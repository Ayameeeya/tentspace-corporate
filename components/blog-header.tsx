        ...
        <div className="flex items-center justify-between px-4 py-3 md:px-8 md:py-6">
          ...
          <div className="pointer-events-auto">
            {loading ? (
              ...
              >
                <div className="relative px-4 py-1.5 md:px-5 md:py-2 border border-white bg-white text-black text-[10px] md:text-xs font-semibold tracking-wide transition-all duration-300 mix-blend-difference">
                  SIGN IN
                </div>
              </button>
            )}
