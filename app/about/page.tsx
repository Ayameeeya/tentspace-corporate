      ...
      <div className="relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-7xl mx-auto w-full">
            ...
            <div className="hero-content">
              <div className="overflow-hidden mb-4">
                <p className="hero-label font-mono text-blue-400 text-xs tracking-[0.3em] uppercase">About Us</p>
              </div>
              <div className="overflow-hidden">
                <h1 className="hero-title font-[family-name:var(--font-display)] text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[0.9]">
                  tent<span className="text-blue-500">␣</span>
                </h1>
              </div>
              <div className="overflow-hidden mt-4">
                <p className="hero-subtitle text-base md:text-lg text-white/50 tracking-wide font-mono">
            ...
            <div className="hero-statement lg:pl-12 border-l border-white/10">
              <div className="space-y-5">
                <div className="overflow-hidden">
                  <p className="hero-text text-xl md:text-2xl lg:text-3xl font-medium text-white/90 leading-relaxed">
                ...
                <div className="overflow-hidden">
                  <p className="hero-text text-xl md:text-2xl lg:text-3xl font-medium text-white leading-relaxed">
                    AIを<span className="text-blue-400">武器</span>に、共に創る。
                  </p>
                </div>
              </div>

              <div className="hero-line mt-10 pt-6 border-t border-white/10">
                <p className="text-white/40 text-xs font-mono tracking-wider">EST. 2023 — IZU, JAPAN</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="min-h-screen flex items-center px-6 md:px-12 lg:px-24 section-fade">
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
            <div className="parallax-slow">
              <p className="font-mono text-blue-400 text-xs tracking-[0.3em] mb-6">OUR MISSION</p>
        ...
        <section className="py-32 px-6 md:px-12 lg:px-24 section-fade">
          <div className="max-w-7xl mx-auto">
            <div className="mb-16 text-stagger">
              <p className="font-mono text-blue-400 text-[10px] tracking-[0.3em] mb-6 uppercase">COMPANY</p>
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight">会社概要</h2>
            </div>
            ...
            <div className="border border-white/10 backdrop-blur-sm">
              {[
                ...
                >
                  <div className="px-6 py-4 md:py-5 font-mono text-blue-400 text-xs bg-white/[0.02]">{item.label}</div>
                  <div className="px-6 py-4 md:py-5 text-white/80 text-sm whitespace-pre-line">{item.value}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-stagger">
              {[
                ...
                <div key={i} className="text-center">
                  <div className="text-5xl md:text-7xl font-bold text-blue-500 mb-2">{stat.value}</div>
                  <div className="text-white/40 font-mono text-xs tracking-wider">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="min-h-screen flex items-center py-32 px-6 md:px-12 lg:px-24 section-fade">
          <div className="max-w-7xl mx-auto w-full">
            <div className="mb-20 text-stagger">
              <p className="font-mono text-blue-400 text-xs tracking-[0.3em] mb-6">OUR VALUES</p>
              <h2 className="text-4xl md:text-6xl font-bold tracking-tight">私たちの価値観</h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="value-card p-8 md:p-10 border border-white/10 backdrop-blur-sm hover:border-blue-500/50 transition-colors cursor-default"
                >
                  <span className="font-mono text-blue-500 text-sm">{value.num}</span>
                  <h3 className="text-2xl md:text-3xl font-bold mt-4 mb-4">{value.title}</h3>
        ...
        <section className="py-32 px-6 md:px-12 lg:px-24 section-fade">
          <div className="max-w-7xl mx-auto">
            <div className="mb-20 text-stagger">
              <p className="font-mono text-blue-400 text-xs tracking-[0.3em] mb-6">SERVICES</p>
              <h2 className="text-4xl md:text-6xl font-bold tracking-tight">提供サービス</h2>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={i}
                  className="group flex items-center justify-between p-6 border-b border-white/10 hover:border-blue-500/50 transition-all cursor-default"
                >
                  <div className="flex items-center gap-8">
                    <span className="font-mono text-blue-500/50 text-sm">{String(i + 1).padStart(2, "0")}</span>
        ...
        <section className="min-h-screen flex items-center justify-center px-6 md:px-12 section-fade">
          <div className="text-center max-w-3xl">
            <div className="text-stagger">
              <p className="font-mono text-blue-400 text-xs tracking-[0.5em] uppercase mb-8">NEXT STEP</p>
              <h2 className="text-5xl md:text-7xl font-bold tracking-tight mb-8">
                Let's build
                <br />
                the future
              </h2>
              <p className="text-white/50 text-lg mb-12">AIがビジネスをどう変革できるか、一緒に考えましょう。</p>
              <Link
                href="/#contact"
                className="inline-flex items-center gap-4 text-xl font-medium text-blue-400 hover:text-blue-300 transition-colors group"
              >
  ...
  return (
    <footer className="relative z-20 px-4 md:px-8 py-0.5">
      <div className="flex justify-end">
        <p className="text-[9px] text-white/40">© 2025 tent space Inc. All rights reserved.</p>
      </div>
    </footer>
  )
}
