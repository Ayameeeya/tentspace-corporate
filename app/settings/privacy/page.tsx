    ...
    <div className="max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">プロフィールの公開範囲</h2>
        ...
        {/* Activity Visibility */}
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">アクティビティの公開</h2>
        ...
        {/* Data & Privacy */}
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">データとプライバシー</h2>
          
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                <p className="text-sm font-medium text-gray-900">データのダウンロード</p>
                <p className="text-xs text-gray-500 mt-1">あなたのすべてのデータをダウンロードします</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg">
              <div>
                <p className="text-sm font-medium text-red-900">アカウントの削除</p>
                <p className="text-xs text-red-600 mt-1">アカウントとすべてのデータを完全に削除します</p>
              </div>
              <Button 
                variant="outline" 
                size="sm"
