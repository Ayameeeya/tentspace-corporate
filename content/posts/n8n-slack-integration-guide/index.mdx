...
1.  Slack API管理ページ（[https://api.slack.com/apps）にアクセス](https://api.slack.com/apps）にアクセス)
...
-   **URL**：RSSフィードのURL（例：[https://rss.itmedia.co.jp/rss/2.0/news\_bursts.xml）](https://rss.itmedia.co.jp/rss/2.0/news_bursts.xml）)
